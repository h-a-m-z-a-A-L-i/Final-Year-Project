"""AIML API client — DISABLED (using Cerebras until project finalized).

Uncomment and wire via config.py when switching back from Cerebras.
Configure via .env: AIML_API_KEY, AIML_MODEL.
"""
