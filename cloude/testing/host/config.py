...
_AGENTIC_MANDATORY_TWO_PHASE_RAW = os.environ.get("AGENTIC_MANDATORY_TWO_PHASE", "1").strip().lower()
AGENTIC_MANDATORY_TWO_PHASE = _AGENTIC_MANDATORY_TWO_PHASE_RAW not in ("0", "false", "no", "off")
