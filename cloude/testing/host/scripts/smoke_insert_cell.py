#!/usr/bin/env python3
"""Live smoke test for insert_cell."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Smoke test insert_cell tool")
    ...
    print("Calling insert_cell with:", json.dumps(payload, indent=2))
    result = registry().call("insert_cell", payload)
    print("\nResult:")
