...
_BOT_RESULT_TYPES = frozenset({
    ...
    "CLICK_CELL_DELETE_BUTTON_RESULT", "CLICK_CELL_DELETE_BUTTON_ERROR",
    "CLICK_CELL_MARKDOWN_BUTTON_RESULT", "CLICK_CELL_MARKDOWN_BUTTON_ERROR",
    ...
    "GET_CELL_EXECUTION_TITLE_RESULT", "GET_CELL_EXECUTION_TITLE_ERROR",
    "GET_ACTIVE_CELL_INDEX_RESULT", "GET_ACTIVE_CELL_INDEX_ERROR",
    "GET_CELL_CONTENT_RESULT", "GET_CELL_CONTENT_ERROR",
