# GCUF BS/MS/PhD FYP/Thesis Style

The project is accessible as an [Overleaf template]%%(https://www.overleaf.com/latex/templates/GCUF/bmkdkrfxqdmb)

For the moment I have added only  GCUF Data Science Department, being an open-source project, I will be happy to get valuable [feedback and additional](https://github.com/usmangcuf/issues) features from colleagues and students to further stabilize and improve the project, Happy exploring

Muhammad Usman
https://github.com/usmangcuf
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.7\columnwidth]{gcuf.jpg}
  \caption{GCUF Emblem.}
  \label{f-gcuf}
\end{center}
\end{figure}
