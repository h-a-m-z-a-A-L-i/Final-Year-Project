...
% Front matter only — stops before \resetpagenumbering and Chapter 1.
% Build: pdflatex x2 (no biber). Output: build/_fyp-frontmatter-preview.pdf
...
\begin{center}
\vfill
{\large\textit{End of front matter preview}}
\vfill
\end{center}
